...
Yukarıdaki propertylere sahip bir Araba classı tanımlandı.

Program akışı:

1- Konsol ekranından kullanıcıya araba üretmek isteyip istemediğini soruyoruz. Üretmek istiyorsa e, istemiyorsa h harfi ile yanıt versin. Büyük - Küçük harf duyarlılığını ortadan kaldıralım. Geçersiz bir cevap verirse, bu cevabın geçersiz olduğunu söyleyerek aynı soruyu tekrar yöneltelim.
...
4- Kapı Sayısı için sayısal olmayan bir değer atanılmaya çalışılırsa programın exception fırlatmasını engelleyelim, uyarı mesajı verelim ve kullanıcıyı yeniden o satıra yönlendirelim.

5- Oluşturulan araba nesnesini bir listeye atayınız.
